-- Date dimension over the green-taxi archive's span. Spark builds the range with
...
-- The span stays 2011-01-01..2026-12-31 even though the archive starts 2014-01 — see the duckdb
-- copy's header for why narrowing it would inner-join misfiled pickup dates away in DAX.
{{ config(
