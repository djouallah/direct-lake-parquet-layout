...
-- month is missing. The ONLY assertion on this table, and the analogue of AEMO's
...
-- meant to be free of.
--
-- DuckDB dialect (duckrun + iceberg). tests/nyc/dwh and tests/nyc/spark hold the same assertion in
