...
-- month is missing. Spark SQL dialect (Fabric Spark). Same assertion as
-- tests/nyc/duckdb/assert_fct_trips_matches_archive_log.sql — read that one for why it takes this
-- shape rather than a grain check, and why it is allowed to read two tables.
--
