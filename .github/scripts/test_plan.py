...
CASES = [
    ...
    # No dataset declares `download_limits` today (it is a registry capability, not any one
    # dataset's), so nothing here is refused on the limit and a stale 200 is inert.
