...
| bts | `writeHeavy` | **4,071** | 126% | **1,093** | 114% | 180.5M | 6.7–6.9M | 2,441 |
| cms | `readHeavyForPBI` | **9,870** | 100% | **1,173** | 100% | 87.7M | 1.4–1.6M | 3,032–3,107 |
| cms | `writeHeavy` | **7,470** | 76% | **2,043** | 174% | 87.7M | 1.3M | 5,582 |
| green | `readHeavyForPBI` | **1,978** | 100% | **2,840** | 100% | 84.3M | 2.3M | 1,546 |
| green | `writeHeavy` | **1,493** | 75% | **2,668** | 94% | 84.3M | 3.4M | 1,623 |
