...
release — stable is 1.5.5 — but the pre-release wheel both DuckDB legs pin now CARRIES it: run
34739218189 wrote an Iceberg table into OneLake on that exact wheel and its parquet's
`encoding_stats` declare a dictionary page. No benchmark run here carries it yet, since the pin
moved on 2026-09-13 and nothing has been dispatched on it since, so the iceberg column should close
on the others at the next iceberg run.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| aemo | `readHeavyForPBI` | **32,541** | 100% | **1,618** | 100% | 144.0M | 9.6–16.0M | 4,117–4,351 |
| aemo | `writeHeavy` | **35,289** | 108% | **3,769** | 233% | 144.0M | 1.4–11.1M | 5,298–5,752 |
| bts | `readHeavyForPBI` | **3,231** | 100% | **962** | 100% | 180.5M | 6.7M | 2,585 |
| bts | `writeHeavy` | **4,011** | 124% | **1,070** | 111% | 180.5M | 6.7–6.9M | 2,441 |
| cms | `readHeavyForPBI` | **9,768** | 100% | **1,235** | 100% | 87.7M | 1.4–1.6M | 3,032–3,107 |
| cms | `writeHeavy` | **8,051** | 82% | **2,029** | 164% | 87.7M | 1.3M | 5,582 |
| green | `readHeavyForPBI` | **1,978** | 100% | **2,840** | 100% | 84.3M | 2.3M | 1,546 |
| green | `writeHeavy` | **1,554** | 79% | **2,761** | 97% | 84.3M | 3.4M | 1,623 |
| nyc | `readHeavyForPBI` | **11,606** | 100% | **6,499** | 100% | 591.7M | 5.7–10.4M | 5,850–5,867 |
| nyc | `writeHeavy` | **10,522** | 91% | **8,689** | 134% | 591.7M | 5.8–10.4M | 9,200–9,291 |
